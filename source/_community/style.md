...
---
  ...
  <div class="hero">
    <button class="tfm-btn tfm-btn-l tfm-fill-color">Be a Free Maven</button>
    <button class="tfm-btn tfm-fill-light">Be a Free Maven</button>
    <button class="tfm-btn tfm-btn-s tfm-fill-dark">Be a Free Maven</button>
    <button class="tfm-btn tfm-btn-s tfm-fill-mute">Be a Free Maven</button>
  </div>
  ...
  <div class="hero">
    ...
    <h5>Title h5</h5>
    <h6>Title h6</h6>
    <h6 class="h7">Title h7</h6>
    <p>Paragraph</p>
  </div>

<!-- Source: http://www.cs.tut.fi/~jkorpela/www/testel.html -->
...
<button class="tfm-btn tfm-fill-color" id="but" type="submit" name="foo" value="bar">A cool button</button></label></div>
