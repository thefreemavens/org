<template>
  <div class="main">
    ...
    <section v-if="episode.slides.length">
      ...
      <div class="content content-m two-columns">
        <img
...
// import IconSg4 from '@/components/icons/IconSg4'
      ...
      episodes: [
        ...
        },
        {
          ...
          notes: [
            ...
            `<b class="brand">1.</b> Set aside your perceptions of me as the presenter. Including:  How you think I look, dress, or sound.`,
